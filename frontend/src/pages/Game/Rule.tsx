...
const Rule = () => {
  ...
  const ruleSteps = [
    { step: 1, title: 'Start the Game', description: <>Click <span className="bg-green-300 px-2 py-0.5 rounded-full text-sm">start</span> on the main screen</> },
  ...
  return (
    <div className="min-h-screen bg-white flex">
      ...
      <main className="flex-1 p-10 relative font-sans">
        ...
        {/* กล่อง rule steps */}
        <div className="ml-80  w-full space-y-6">
            {ruleSteps.map((step, i) => (
                ...
                >
                    ...
                    {/* กล่องหลัก */}
                    <div className="relative bg-orange-300 px-4 py-3 rounded-xl shadow-lg flex items-start gap-4 z-10">
                        <div className="bg-blue-700 text-white w-10 h-10 rounded-full flex items-center justify-center text-2xl mt-1 font-syne">
                            {step.step}
                        </div>
