...
const TeamCardWidget: FC<TeamCardProps> = ({ name, description, createBy, joinCode }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow p-4 space-y-2 hover:shadow-lg transition">
